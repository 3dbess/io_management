...
def scan_algorithm(initial_position, requests):
    ...
    # Add the end track (199) if not already in the requests
...
def plot_graph(order_served):
    ...
    plt.title('SCAN (Elevator) Disk Scheduling Algorithm')
...
if __name__ == "__main__":
    ...
    # Run SCAN algorithm
    total_head_movement, order_served = scan_algorithm(initial_position, requests)
